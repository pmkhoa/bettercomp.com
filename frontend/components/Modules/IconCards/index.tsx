...
export default function IconCardsModule({ block }: { block: IconCards }) {
  ...
  return (
    <section className={cn('section-module relative', 'icon-cards bg-blue py-16 md:py-24')}>
      <div className="h-3 md:h-4 bg-[linear-gradient(81deg,var(--color-orange)_9.79%,var(--color-gold)_84.97%)] w-[60%] md:w-[50%] left-[20%] md:left-[25%] absolute top-[-6px] md:top-[-8px] z-20" />
      <div
